...
const nextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      "connect-src 'self' blob: https://api.qrserver.com https://*.googleapis.com https://*.upstash.io https://*.digitaloceanspaces.com https://sgp1.digitaloceanspaces.com https://fastly.jsdelivr.net https://*.sentry.io",
      "media-src 'self' data:",
