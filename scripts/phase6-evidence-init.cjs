...
function run() {
  ...
  const content = `# Release Evidence ${now.toISOString()}\n\n## Metadata\n- Release identifier:\n- Environment:\n- Freeze active: Yes / No\n\n## Checklist Status\n- [ ] Quality gates\n- [ ] Test gates\n- [ ] Migration drift check\n- [ ] Rollback verification\n- [ ] Backup/restore drill\n\n## Evidence Links\n- [PHASE6_RELEASE_CHECKLIST.md](../../docs/PHASE6_RELEASE_CHECKLIST.md)\n- [PHASE6_DRILL_RUNBOOK.md](../../docs/PHASE6_DRILL_RUNBOOK.md)\n- [PHASE6_FREEZE_POLICY.md](../../docs/PHASE6_FREEZE_POLICY.md)\n- [PHASE6_READINESS_SIGNOFF.md](../../docs/PHASE6_READINESS_SIGNOFF.md)\n\n## Approval Notes\n### Release Owner\n- Decision:\n- Notes:\n\n### Tech Lead\n- Decision:\n- Notes:\n\n### Product Owner\n- Decision:\n- Notes:\n`;
