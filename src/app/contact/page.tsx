...
const INQUIRY_DATA = [
  {
    ...
    contacts: [
      { name: "Genral Secretary", phone: "+91 98765 43210" },
      { name: "Joint Secretary", phone: "+91 98765 43211" }
    ],
    email: "shackles.acgcet@gmail.com"
  },
  {
  ...
  },
  {
    title: "Event Queries",
    contacts: [
      { name: "Event Director", phone: "+91 98765 43214" }
    ],
    email: "shackles.acgcet@gmail.com"
  }
];
        ...
        <div className="bg-black text-white p-10 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="mt-8 z-10 space-y-3">
            {INQUIRY_DATA.map((item, idx) => (
              <div
                key={idx}
                className={`border rounded-xl transition-all duration-300 overflow-hidden ${openSection === idx
              ...
              >
                ...
                <div
                  className={`overflow-hidden transition-all duration-300 ease-in-out ${openSection === idx ? "max-h-60 opacity-100" : "max-h-0 opacity-0"
                    }`}
                >
