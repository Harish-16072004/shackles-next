...
function createPrismaClient() {
  ...
  // ---------------------------------------------------------------------------
  // Accelerate note: if DATABASE_URL starts with prisma://, manually extend:
  //   import { withAccelerate } from '@prisma/extension-accelerate';
  //   return client.$extends(withAccelerate()) as unknown as PrismaClient;
  // ---------------------------------------------------------------------------
  if (isAccelerate) {
    console.warn(
      "[prisma] DATABASE_URL is a prisma:// Accelerate URL. " +
      "Install @prisma/extension-accelerate and extend the client manually."
    );
  }
...
// ---------------------------------------------------------------------------
if (process.env.NODE_ENV === "production" && typeof process !== "undefined" && typeof process.once === "function") {
